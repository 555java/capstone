...
This project is clothing store consisting of main page with all categories, page with preview of each category, specific category pages, checkout and sign in.
<br/><br/>
...
<p align="center">
 **It works**
 It works as good for desktop, as for mobile
 <br/><br/>
...
### *This project was done with EJS, SASS, HTML, JS, and different npm packages.*
Also there were used the technologies of Google Firebase to save the data about users and products, and Stripe functionality to test the chechout possibilities.
Both of them work correctly, and it were fun to discover how to work with it.
